  ...
  render: (data) => {
    ...
    const content = `
      <div class="container__content" data-testid="home">
        ...
        <p class="container--small">Quelles sont ses préférences, ses qualités, une petite anecdote… La description sera ensuite envoyée à ${
          data.singleFirstname
        } qui décidera de l’afficher sur son profil.</p>
      </div>
